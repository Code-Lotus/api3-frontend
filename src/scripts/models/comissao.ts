...
//    }
    ...
    public acharTipo(cliente: Cliente, produto: Produto): string{
        ...
        const clienteNovo = hoje.getFullYear() - cliente.dataCadastro.getFullYear() <= 1  // só q se ele for maior que 1 ano por meses ainda retorna 1
        const produtoNovo = hoje.getFullYear() - produto.dataCadastro.getFullYear() <= 1
